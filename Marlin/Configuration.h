...
#define STRING_CONFIG_H_AUTHOR "(Anson Liu, UM2+ Octopus Pro DXUv2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "UltiDXUv2"
...
#define HOTEND_OFFSET_X { 0.0, 17.90 } // (mm) relative X-offset for each nozzle
#define HOTEND_OFFSET_Y { 0.0, 0.175 }  // (mm) relative Y-offset for each nozzle
#define HOTEND_OFFSET_Z { 0.0, -2.025 }  // (mm) relative Z-offset for each nozzle
...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST { 15.15, 15.53 }
    #define DEFAULT_Ki_LIST {  1.78,  1.79 }
    #define DEFAULT_Kd_LIST { 32.26, 33.71 }
  #else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 715, 360 }
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 18000, 18000, 200, 20000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 9, -19.5, -0.67 }
...
#define X_BED_SIZE 221 //226
#define Y_BED_SIZE 216 //224
...
#define PREHEAT_5_TEMP_CHAMBER 50
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_CENTER), (Y_MIN_POS + 3), 20 }
